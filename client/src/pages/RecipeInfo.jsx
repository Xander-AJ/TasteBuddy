        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/3 bg-gray-50 p-8 border-l border-gray-200">
            <div className="flex justify-between items-center mb-8">
              <div className="flex items-center">
                <span className="text-2xl font-semibold text-gray-700 mr-2">Rate:</span>
                {[1, 2, 3, 4, 5].map((star) => (
                  <FaStar
                    key={star}
                    className={`cursor-pointer text-2xl transition-colors duration-200 ${star <= rating ? 'text-yellow-400' : 'text-gray-300'} hover:text-yellow-300`}
            ...
            <form className="mt-6" onSubmit={handleSubmitComment}>
              ...
              ></textarea>
              <button type="submit" className="mt-3 bg-green-500 text-white px-6 py-3 rounded-full hover:bg-green-600 transition-all duration-300 w-full transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-opacity-50">
                Submit Comment
              </button>
            </form>
          </div>
