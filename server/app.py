...
def create_bookmark():
    data = request.get_json()
    new_bookmark = Bookmark(userId=data["userId"], recipeId=data["recipeId"])
...
def create_like():
    data = request.get_json()
    new_like = Like(userId=data["userId"], recipeId=data["recipeId"])
...
def create_rating():
    data = request.get_json()
    new_rating = Rating(
        userId=data["userId"], recipeId=data["recipeId"], rating=data["rating"]
    )
...
def create_notification():
    ...
    new_notification = Notification(
        userId=data["userId"], message=data["message"], isRead=data.get("isRead", False)
    )
...
def create_comment():
    data = request.get_json()
    new_comment = Comment(
        userId=data["userId"], recipeId=data["recipeId"], content=data["content"]
    )
